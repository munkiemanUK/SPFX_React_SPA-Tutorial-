 ...
 * @public
 */
class ApiConstructor extends ApiParameterListMixin_1.ApiParameterListMixin(ApiReleaseTagMixin_1.ApiReleaseTagMixin(ApiStaticMixin_1.ApiStaticMixin(ApiDeclaredItem_1.ApiDeclaredItem))) {
    static getCanonicalReference(isStatic, overloadIndex) {
        if (isStatic) {
